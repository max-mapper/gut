...
exports ['can curry a function'] = function (){
  ...
  test.deepEqual(cx(),[1,undefined,undefined])
  ...
  test.deepEqual(xc(),[1,undefined,undefined])
...
exports ['can curry a function, and args are in right place'] = function (){
  ...
  test.deepEqual(cx('X'),[1,'X',undefined])
  ...
  test.deepEqual(xc('X'),['X',1,undefined])
}
...
exports ['can curry a function, this passed in'] = function (){
  ...
  test.deepEqual(ys('X'),{self: s, args: ['X',undefined,undefined]})

  test.deepEqual(cys('X'),{self: s, args: [1,'X',undefined]})

  test.deepEqual(ycs('X'),{self: s, args: ['X',2,undefined]})

  test.deepEqual(cycs('X'),{self: s, args: [1,'X',2]})
